    ...
    return (
        <>
            ...
            <ul className="top-nav">
                <li className="d-xl-none"><a href="" data-sa-action="search-open"><i className="zwicon-search"></i></a></li>
                            ...
                            <div className="listview__scroll scrollbar">
                               {notifications.map(notification => (
                                   <a href="" className="listview__item" key={notification.id}>
                                       <img src={notification.source} className="avatar-img" alt="" />

                                       <div className="listview__content">
                                           <div className="listview__heading">{notification.text}</div>
